...
uint8_t sample_input_pin() {
    ...
    Serial.print(digitalRead(dcf77_signal_good_indicator_pin));
    Serial.print(sampled_data);
    Serial.print(synthesized_signal);
    Serial.println(digitalRead(dcf77_synthesized_pin));
